            ...
            <div class="row">
                <div class="8u 12u(mobile)">
                    ...
                    <section class="box article-list">
                        ...
                        <!-- Excerpt -->
                        <article class="box excerpt">
                            <a href="#" class="image left"><img src="/assets/images/pic05.jpg" alt=""/></a>
                            <div>
                                <header>
                                    <span class="date">March 18</span>
                                    <h3><a href="#">Fotografia de arhitectura</a></h3>
                                </header>
                                <p>Phasellus quam turpis, feugiat sit amet ornare in, hendrerit in lectus
                                    semper mod quisturpis nisi consequat etiam lorem. Phasellus quam turpis,
                                    feugiat et sit amet ornare in, hendrerit in lectus semper mod quis eget mi
                        ...
                        <article class="box excerpt">
                            ...
                            <div>
                                <header>
                                    ...
                                    <h3><a href="#">Fotografia de portret</a></h3>
                                </header>
                                <p>Phasellus quam turpis, feugiat sit amet ornare in, hendrerit in lectus
                                    semper mod quisturpis nisi consequat etiam lorem. Phasellus quam turpis,
                                    feugiat et sit amet ornare in, hendrerit in lectus semper mod quis eget mi
                    ...
                    <section class="box spotlight">
                        ...
                        <article>
                            ...
                            <p>Phasellus quam turpis, feugiat sit amet ornare in, hendrerit in lectus semper mod
                                quisturpis nisi consequat ornare in, hendrerit in lectus semper mod quis eget mi quat
                                etiam
                                lorem. Phasellus quam turpis, feugiat sed et lorem ipsum dolor consequat dolor feugiat
                                sed
